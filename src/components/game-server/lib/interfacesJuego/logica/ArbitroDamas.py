...
class ArbitroDamas(Arbitro):
    ...
    def movimientoLegal(self, fila1, columna1, fila2, columna2):
        if self.tablero[fila1][columna1] is not 0:
            if self.tablero[fila1][columna1] == 'n' or self.tablero[fila1][columna1] == 'b':
                if fila1 == 2 or fila1 == 5:
                    self.devolver = self.esValidoPeonPrimero(
                        fila1, columna1, fila2, columna2)
                else:
                    self.devolver = self.esValidoPeonSegundo(
                        fila1, columna1, fila2, columna2)
            elif self.tablero[fila1][columna1] == 'N' or self.tablero[fila1][columna1] == 'B':
                self.devolver = self.esValidoDamas(
                    fila1, columna1, fila2, columna2)
        return self.devolver

    def esValidoPeonPrimero(self, fila1, columna1, fila2, columna2):
        if self.tablero[fila1][columna1] is not 0:
            if self.tablero[fila2][columna2] == 0:
    ...
    def esMovimientoDiagonalPrimero(self, fila1, columna1, fila2, columna2):
        if (fila1 >= 0) and (fila1 <= 7) and (fila2 >= 0) and (fila2 <= 7) and (columna1 >= 0) and (columna1 <= 7) and (columna2 >= 0) and (columna2 <= 7):
            ...
            if self.tablero[fila1][columna1] == 'n':
                if resta == 0 or resta == 2 or resta == 4:
                    if resta == 4:
                        if self.tablero[fila1+1][columna1+1] == 'b':
                            self.grid.quitarPieza(fila1+1, columna1+1)
                        elif self.tablero[fila1+1][columna1-1] == 'b':
                            self.grid.quitarPieza(fila1+1, columna1-1)
                    return True
            elif self.tablero[fila1][columna1] == 'b':
                if resta == 0 or resta == -2 or resta == -4:
                    if resta == 4:
                        if self.tablero[fila1-1][columna1+1] == 'n':
                            self.grid.quitarPieza(fila1-1, columna1+1)
                        elif self.tablero[fila1-1][columna1-1] == 'n':
                            self.grid.quitarPieza(fila1-1, columna1-1)
                    return True
            else:
                return False
    ...
    def esMovimientoDiagonalSegundo(self, fila1, columna1, fila2, columna2):
        if (fila1 >= 0) and (fila1 <= 7) and (fila2 >= 0) and (fila2 <= 7) and (columna1 >= 0) and (columna1 <= 7) and (columna2 >= 0) and (columna2 <= 7):
            resta = (fila1+columna1)-(fila2+columna2)
            if self.tablero[fila1][columna1] == 'n':
                if self.tablero[fila1+1][columna1+1] == 0 or self.tablero[fila1+1][columna1+1] == 'b' or self.tablero[fila1+1][columna1+1] == 'B':
                    self.grid.quitarPieza(fila1+1, columna1+1)
                    if resta == 0 or resta == 4:
                        return True
                elif self.tablero[fila1+1][columna1-1] == 0 or self.tablero[fila1+1][columna1-1] == 'b' or self.tablero[fila1+1][columna1-1] == 'B':
                    self.grid.quitarPieza(fila1+1, columna1-1)
                    if resta == 0 or resta == 4:
                        return True
            elif self.tablero[fila1][columna1] == 'b':
                if self.tablero[fila1-1][columna1+1] == 0 or self.tablero[fila1-1][columna1+1] == 'n' or self.tablero[fila1-1][columna1+1] == 'N':
                    self.grid.quitarPieza(fila1-1, columna1+1)
                    if resta == 0 or resta == -4:
                        return True
                elif self.tablero[fila1-1][columna1-1] == 0 or self.tablero[fila1-1][columna1-1] == 'n' or self.tablero[fila1-1][columna1-1] == 'N':
                    self.grid.quitarPieza(fila1-1, columna1-1)
                    if resta == 0 or resta == -4:
                        return True
            else:
    ...
    def esMovimientoDiagonalDama(self, fila1, columna1, fila2, columna2):
        if (fila1 >= 0) and (fila1 <= 7) and (fila2 >= 0) and (fila2 <= 7) and (columna1 >= 0) and (columna1 <= 7) and (columna2 >= 0) and (columna2 <= 7):
            resta = (fila1+columna1)-(fila2+columna2)
            if self.tablero[fila1][columna1] == 'B':
                if resta == 0 or resta == 2 or resta == 4 or resta == 6 or resta == 8 or resta == 10 or resta == 12:
                    if resta > 2:
                        if (fila1+1 <= fila2) and self.tablero[fila1+1][columna1] == 'n' or self.tablero[fila1+1][columna1] == 'N':
                            self.grid.quitarPieza(fila1+1, columna1)
                        elif (fila1+3 <= fila2) and self.tablero[fila1+3][columna1] == 'n' or self.tablero[fila1+3][columna1] == 'N':
                            self.grid.quitarPieza(fila1+3, columna1)
                        elif (fila1+5 <= fila2) and self.tablero[fila1+5][columna1] == 'n' or self.tablero[fila1+5][columna1] == 'N':
                            self.grid.quitarPieza(fila1+5, columna1)
                        elif (fila1+7 <= fila2) and self.tablero[fila1+7][columna1] == 'n' or self.tablero[fila1+7][columna1] == 'N':
                            self.grid.quitarPieza(fila1+7, columna1)
                    return True
            elif self.tablero[fila1][columna1] == 'N':
                if resta == 0 or resta == -2 or resta == -4 or resta == -6 or resta == -8 or resta == -10 or resta == -12:
                    if resta < -2:
                        if (fila1-1 <= fila2) and self.tablero[fila1-1][columna1] == 'n' or self.tablero[fila1-1][columna1] == 'N':
                            self.grid.quitarPieza(fila1-1, columna1)
    ...
    def estaAcabado(self):
        ...
        for i in range(len(self.tablero)):
            for j in range(len(self.tablero)):
                celda = self.tablero.grid[i][j]
                if celda == 'n' or celda == 'N':
                    contadorN += 1
                elif celda == 'b' or celda == 'B':
                    contadorB += 1
